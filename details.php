                  ...
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/details-router.php" novalidate="novalidate"class="col s12">
                      ...
                      <div class="row">
                        ...
                        <div class="input-field col s12">
                          <i class="mdi-action-home prefix"></i>
                          <textarea name="pincode" id="pincode" type="number"class="materialize-textarea validate" data-error=".errorTxt7"><?php echo $pincode;?></textarea>
    ...
    $("#formValidate").validate({
      ...
      pincode: {
        ...
        messages: {
            ...
            pincode:{
        required: "Enter 6 Digit pincode",    
      },      
        },
        errorElement : 'div',
